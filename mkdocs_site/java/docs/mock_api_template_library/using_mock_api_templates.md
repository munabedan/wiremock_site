...
See [this page](../running_wiremock/running_as_a_standalone_process.md) for general details on running WireMock standalone.
...
See [this page](../running_wiremock/running_as_a_standalone_process.md) for general details on running WireMock Docker.
...
See [this](../java_usage/plain_java.md) for general details on running WireMock in embedded Java.
...
See [this](../java_usage/junit_5_plus_jupiter.md) for general details on running WireMock with JUnit 5+ Jupiter.

## Pushing to a remotely running WireMock server

The mock API JSON can be pushed to a remotely running WireMock server via its [Admin API](../reference/admin-api-reference.md).
