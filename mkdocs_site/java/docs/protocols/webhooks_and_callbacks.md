...
Webhooks use the same [templating system](../stubbing_and_verifying/response_templating.md) as WireMock responses. This means that any of the
...
A fixed or random delay can be added before the webhook call is made, using the same style of [delay parameters as stubs](../stubbing_and_verifying/simulating_faults.md).
